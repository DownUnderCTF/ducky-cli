...
describe('challenge:lint', () => {
    ...
    test
        ...
        .command([
            'challenge:lint',
            '--directory', 'test',
            '--ignore', 'C000,C001,C002,C003,C004,C005,C006',
            '--format', 'json',
            '--verbose',
        ])
        .exit(1)
        .it('checks structural rules', ({ stdout }) => {
            ...
            expect(getFindingByCode(result.findings, 'S001')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'S002')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'S003')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'S004')).to.not.be.undefined;
        });
    ...
    test
        ...
        .it('checks basic configuration rules', ({ stdout }) => {
            ...
            expect(getFindingByCode(result.findings, 'C000')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'C001')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'C002')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'C003')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'C004')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'C005')).to.not.be.undefined;
        });
    ...
    test
        ...
        .command([
            'challenge:lint',
            '--directory', 'test',
            '--ignore', 'S001,S002,S003,S004,C000,C001,C002,C003,C004,C005',
            '--format', 'json',
            '--verbose',
        ])
        .exit(1)
        .it('checks fs-touching configuration rules', ({ stdout }) => {
            ...
            expect(getFindingByCode(result.findings, 'C006')).to.not.be.undefined;
            expect(getFindingByCode(result.findings, 'C006')).satisfies(
                (f: LintResult) => f.violation?.message?.includes('test-nonexistant')
            );
        });
